...
def rename_wrfinput(path_dir_output, file_to_change):
    # Renaming the changed input file to be consistent with others
    print('Renaming the changed input file to be consistent with others')
...
path_dir_output = (
    Path("./sample-case/" + wsps_config.output_file_name).expanduser().resolve()
)
...
rename_wrfinput(path_dir_output, file_to_change)
################################################################
