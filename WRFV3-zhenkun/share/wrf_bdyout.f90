...
CALL wrf_ext_write_field (  &
                       ...
                       'bdy perturbation dry air mass in column'               , &  
                       'Pa'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy perturbation dry air mass in column'               , &  
                       'Pa'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy perturbation dry air mass in column'               , &  
                       'Pa'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy perturbation dry air mass in column'               , &  
                       'Pa'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend perturbation dry air mass in column'               , &  
                       '(Pa)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BTXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend perturbation dry air mass in column'               , &  
                       '(Pa)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BTXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend perturbation dry air mass in column'               , &  
                       '(Pa)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BTYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend perturbation dry air mass in column'               , &  
                       '(Pa)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field PC_BTYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
