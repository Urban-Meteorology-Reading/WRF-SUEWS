...
use matsize 
    ...
    if (azimuth > (360-t) .or. azimuth <= (180-t)) then 
        ...
        radD*(1-svfviktbuveg)+radG*albedo*svfviktbuveg*(1-F_sh) 
    else
    Keast=radD*(1-svfviktbuveg)+radG*albedo*svfviktbuveg*(1-F_sh) 
    end if 
    ...
    Ksouth=radD*(1-svfviktbuveg)+radG*albedo*svfviktbuveg*(1-F_sh) 
    end if 
    ...
    Kwest=radD*(1-svfviktbuveg)+radG*albedo*svfviktbuveg*(1-F_sh) 
    end if 
    ...
    Knorth=radD*(1-svfviktbuveg)+radG*albedo*svfviktbuveg*(1-F_sh) 
    end if 
