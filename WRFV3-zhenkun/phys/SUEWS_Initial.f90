...
SUBROUTINE OverallRunControl
  ...
  OPEN(55,File='RunControl.nml',err=200,status='old') 
  ...
  IF(ResolutionFilesIn==0) ResolutionFilesIn = Tstep   
  ...
  CALL NumberRows(FileN,SkipHeaderSiteInfo)     
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(21,*)   
  ENDDO
  READ(21,*) (HeaderSiteSelect_File(iv),iv=1,ncolumnsSiteSelect) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(22,*)   
  ENDDO
  READ(22,*) (HeaderNonVeg_File(iv),iv=1,ncolumnsNonVeg) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(23,*)   
  ENDDO
  READ(23,*) (HeaderVeg_File(iv),iv=1,ncolumnsVeg) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(24,*)   
  ENDDO
  READ(24,*) (HeaderWater_File(iv),iv=1,ncolumnsWater) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(25,*)   
  ENDDO
  READ(25,*) (HeaderSnow_File(iv),iv=1,ncolumnsSnow) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(26,*)   
  ENDDO
  READ(26,*) (HeaderSoil_File(iv),iv=1,ncolumnsSoil) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(27,*)   
  ENDDO
  READ(27,*) (HeaderCond_File(iv),iv=1,ncolumnsConductance) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(28,*)   
  ENDDO
  READ(28,*) (HeaderOHMCoefficients_File(iv),iv=1,ncolumnsOHMCoefficients) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(28,*)   
  ENDDO
  READ(28,*) (HeaderESTMCoefficients_File(iv),iv=1,ncolumnsESTMCoefficients) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(29,*)   
  ENDDO
  READ(29,*) (HeaderAnthropogenic_File(iv),iv=1,ncolumnsAnthropogenic) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(30,*)   
  ENDDO
  READ(30,*) (HeaderIrrigation_File(iv),iv=1,ncolumnsIrrigation) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(31,*)   
  ENDDO
  READ(31,*) (HeaderProfiles_File(iv),iv=1,ncolumnsProfiles) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(32,*)    
  ENDDO
  READ(32,*) (HeaderWGWaterDist_File(iv),iv=1,ncolumnsWGWaterDist) 
  ...
  DO SkipCounter=1,(SkipHeaderSiteInfo-1)
     READ(33,*)   
  ENDDO
  READ(33,*) (HeaderBiogen_File(iv),iv=1,ncolumnsBiogen) 
  ...
  HalfTimeStep=REAL(tstep_real)/2/(24*3600)   
...
SUBROUTINE InitializeSurfaceCharacteristics(Gridiv,rr)
  ...
  SurfaceChar(Gridiv,c_CpAnOHM(PavSurf))           = NonVeg_Coeff(iv5,ci_CpAnOHM)   
  SurfaceChar(Gridiv,c_KkAnOHM(PavSurf))           = NonVeg_Coeff(iv5,ci_KkAnOHM)  
  SurfaceChar(Gridiv,c_ChAnOHM(PavSurf))           = NonVeg_Coeff(iv5,ci_ChAnOHM)  
  ...
  CALL CodeMatchOHM(Gridiv,PavSurf,'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,PavSurf,'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,PavSurf,'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,PavSurf,'WDry')  
  ...
  SurfaceChar(Gridiv,c_CpAnOHM(BldgSurf))      = NonVeg_Coeff(iv5,ci_CpAnOHM)   
  SurfaceChar(Gridiv,c_KkAnOHM(BldgSurf))      = NonVeg_Coeff(iv5,ci_KkAnOHM)  
  SurfaceChar(Gridiv,c_ChAnOHM(BldgSurf))      = NonVeg_Coeff(iv5,ci_ChAnOHM)  
  ...
  CALL CodeMatchOHM(Gridiv,BldgSurf,'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,BldgSurf,'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,BldgSurf,'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,BldgSurf,'WDry')  
  ...
  SurfaceChar(Gridiv,c_CpAnOHM(ConifSurf))      = Veg_Coeff(iv5,cp_CpAnOHM) 
  SurfaceChar(Gridiv,c_KkAnOHM(ConifSurf))      = Veg_Coeff(iv5,cp_KkAnOHM)  
  SurfaceChar(Gridiv,c_ChAnOHM(ConifSurf))      = Veg_Coeff(iv5,cp_ChAnOHM)  
  ...
  CALL CodeMatchOHM(Gridiv,ConifSurf,'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,ConifSurf,'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,ConifSurf,'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,ConifSurf,'WDry')  
  ...
  SurfaceChar(Gridiv,c_CpAnOHM(DecidSurf))           = Veg_Coeff(iv5,cp_CpAnOHM) 
  SurfaceChar(Gridiv,c_KkAnOHM(DecidSurf))           = Veg_Coeff(iv5,cp_KkAnOHM)  
  SurfaceChar(Gridiv,c_ChAnOHM(DecidSurf))           = Veg_Coeff(iv5,cp_ChAnOHM)  
  ...
  CALL CodeMatchOHM(Gridiv,DecidSurf,'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,DecidSurf,'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,DecidSurf,'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,DecidSurf,'WDry')  
  ...
  SurfaceChar(Gridiv,c_CpAnOHM(GrassSurf))           = Veg_Coeff(iv5,cp_CpAnOHM) 
  SurfaceChar(Gridiv,c_KkAnOHM(GrassSurf))           = Veg_Coeff(iv5,cp_KkAnOHM)  
  SurfaceChar(Gridiv,c_ChAnOHM(GrassSurf))           = Veg_Coeff(iv5,cp_ChAnOHM)  
  ...
  CALL CodeMatchOHM(Gridiv,GrassSurf,'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,GrassSurf,'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,GrassSurf,'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,GrassSurf,'WDry')  
  ...
  SurfaceChar(Gridiv,c_CpAnOHM(BSoilSurf))           = NonVeg_Coeff(iv5,ci_CpAnOHM) 
  SurfaceChar(Gridiv,c_KkAnOHM(BSoilSurf))           = NonVeg_Coeff(iv5,ci_KkAnOHM)  
  SurfaceChar(Gridiv,c_ChAnOHM(BSoilSurf))           = NonVeg_Coeff(iv5,ci_ChAnOHM)  
  ...
  CALL CodeMatchOHM(Gridiv,BSoilSurf,'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,BSoilSurf,'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,BSoilSurf,'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,BSoilSurf,'WDry')  
  ...
  SurfaceChar(Gridiv,c_CpAnOHM(WaterSurf))           = Water_Coeff(iv5,cw_CpAnOHM) 
  SurfaceChar(Gridiv,c_KkAnOHM(WaterSurf))           = Water_Coeff(iv5,cw_KkAnOHM)  
  SurfaceChar(Gridiv,c_ChAnOHM(WaterSurf))           = Water_Coeff(iv5,cw_ChAnOHM)  
  
  CALL CodeMatchOHM(Gridiv,WaterSurf,'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,WaterSurf,'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,WaterSurf,'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,WaterSurf,'WDry')  
  ...
  CALL CodeMatchOHM(Gridiv,(nsurf+1),'SWet')  
  ...
  CALL CodeMatchOHM(Gridiv,(nsurf+1),'SDry')  
  ...
  CALL CodeMatchOHM(Gridiv,(nsurf+1),'WWet')  
  ...
  CALL CodeMatchOHM(Gridiv,(nsurf+1),'WDry')  
  ...
  DO iii=1,(nsurf+1)
     IF(SurfaceChar(Gridiv,c_ESTMCode(iii)) /= 0) THEN 
...
SUBROUTINE InitialState(GridName,year_int,Gridiv,NumberOfGrids)
  ...
  INTEGER::DaysSinceRain,Gridiv,& 
       gamma1,gamma2          
  INTEGER::wd,seas,date,mb,&      
       year_int,switch=0,&    
       id_next,calc           
  ...
  INTEGER:: LeavesOutInitially   
  INTEGER:: SnowInitially        

  INTEGER:: GridsInitialised=0   
  INTEGER:: YearsInitialised=0   
  REAL(KIND(1d0)):: NormalizeVegChar  
  ...
  IF(SnowUse == 0 .OR. SnowInitially == 0) THEN
     ...
     SnowDensWater = 0
     SnowAlb0 = 0
  ELSEIF(SnowInitially == INT(NAN)) THEN   
  ...
  ModelDailyState(Gridiv,cMDS_GDDMin) =  90   
  ModelDailyState(Gridiv,cMDS_GDDMax) = -90   
  ...
  ModelDailyState(Gridiv,cMDS_SnowfallCum) = 0 
  ...
  IF(EmissionsMethod>=0) THEN
     ...
     IF ((Temp_C0-BaseTHDD)>=0) THEN   
        gamma2=1
     ELSE
        gamma2=0
     ENDIF
     IF ((BaseTHDD-Temp_C0)>=0) THEN   
        gamma1=1
     ELSE
        gamma1=0
     ENDIF
     ModelDailyState(Gridiv,cMDS_HDD1) = gamma1*(BaseTHDD-Temp_C0) 
     ModelDailyState(Gridiv,cMDS_HDD2) = gamma2*(Temp_C0-BaseTHDD) 
  ENDIF
  ...
  ModelOutputData(0,cMOD_SoilState(WaterSurf), Gridiv) = 0 
  ...
  CALL day2month(id_prev,mb,date,seas,year_int,lat) 
  CALL Day_of_Week(date,mb,year_int,wd)             
  ...
  DayofWeek(id_prev,1)=wd   
  DayofWeek(id_prev,2)=mb   
  DayofWeek(id_prev,3)=seas 
  ...
  CALL day2month(id_next,mb,date,seas,year_int,lat) 
  CALL Day_of_Week(date,mb,year_int,wd)             
  ...
  DayofWeek(id_next,1)=wd  
  DayofWeek(id_next,2)=mb  
  DayofWeek(id_next,3)=seas 

  

  
  
  IF (id_prev>=startDLS.AND.id_prev<=endDLS) THEN  
     DLS=1
  ELSE
     DLS=0
  ENDIF
  ...
  IF (WaterUseMethod==0) THEN  
     ...
     IF (DayWat(wd)==1.0) THEN 
        IF (lat>=0) THEN            
           IF (id>=Ie_start.AND.id<=Ie_end) calc=1 
        ELSE                        
           calc=1
...
SUBROUTINE NextInitial(GridName,year_int)
  ...
  INTEGER:: year_int
  INTEGER:: ID_Prev_Out 
  INTEGER:: nofDaysThisYear_ForOutput  

  year=year_int   

  
  IF(id==1.AND.iy==(year+1)) THEN   
...
SUBROUTINE SUEWS_InitializeMetData(lunit)
  ...
  REAL(KIND(1d0)):: imin_prev, ih_prev, iday_prev, tstep_met, iy_only   
  ...
  DO i=1,ReadlinesMetdata
     ...
     IF(i==1) THEN
        ...
        iy_only   = MetArray(1)
     ELSEIF(i==2) THEN
        tstep_met = ((MetArray(4)+60*MetArray(3)) - (imin_prev+60*ih_prev))*60   
