...
import urllib2
import cookielib
# use pandas to generate file list according to start and end dates
import pandas as pd
#
if (len(sys.argv) != 2):
...
if (do_authentication):
    login = opener.open(
        ...
        "email=sunting.05@gmail.com&password=" + sys.argv[1] + "&action=login")
#
...
date_start='2016 4 10'
date_end='2016 8 10'
list_date=pd.date_range(date_start,date_end,freq='6h')
list_date.strftime('%Y'+'/'+'%Y%m%d'+'/'+'gfs.0p25.'+'%Y%m%d%H'+'.f')
listoffiles = ["2016/20160419/gfs.0p25.2016041912.f060.grib2",
               "2016/20160419/gfs.0p25.2016041918.f054.grib2", "2016/20160420/gfs.0p25.2016042000.f048.grib2"]
