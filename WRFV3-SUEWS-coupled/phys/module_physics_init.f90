...
CONTAINS
  ...
  REAL,     DIMENSION( 3 ) , INTENT(INOUT), OPTIONAL :: OHMcoef  
  REAL,DIMENSION(ims:ime,jms:jme),INTENT(INOUT)   , OPTIONAL        :: qn1_av_SUEWS
  REAL,DIMENSION(ims:ime,jms:jme,3),INTENT(INOUT) , OPTIONAL        :: LAI_SUEWS      
  REAL,DIMENSION(ims:ime,jms:jme),INTENT(INOUT)   , OPTIONAL        :: albDecTr_SUEWS 
  REAL,DIMENSION(ims:ime,jms:jme),INTENT(INOUT)   , OPTIONAL        :: albEveTr_SUEWS 
  REAL,DIMENSION(ims:ime,jms:jme),INTENT(INOUT)   , OPTIONAL        :: albGrass_SUEWS 
  REAL,DIMENSION(ims:ime,jms:jme),INTENT(INOUT)   , OPTIONAL        :: DecidCap_SUEWS 
  REAL,DIMENSION(ims:ime,jms:jme),INTENT(INOUT)   , OPTIONAL        :: porosity_SUEWS 
  REAL,DIMENSION(ims:ime,jms:jme,5),INTENT(INOUT) , OPTIONAL        :: GDD_SUEWS      
  REAL,DIMENSION(ims:ime,jms:jme,6),INTENT(INOUT) , OPTIONAL        :: HDD_SUEWS      
  REAL,DIMENSION(ims:ime,jms:jme,6),INTENT(INOUT) , OPTIONAL        :: HDD_PREV_SUEWS      
  REAL,DIMENSION(ims:ime,jms:jme,7),INTENT(INOUT) , OPTIONAL        :: state_SUEWS
  REAL,DIMENSION(ims:ime,jms:jme,7),INTENT(INOUT) , OPTIONAL        :: soilmoist_SUEWS
  REAL,DIMENSION(ims:ime,jms:jme,7),INTENT(INOUT) , OPTIONAL        :: surf_var_SUEWS
  REAL,DIMENSION(ims:ime,jms:jme),INTENT(INOUT)   , OPTIONAL        :: dqndt_SUEWS
        ...
        DO ls=1,luseas
          ...
          DO LC=1,LUCATS
            IF(found_lu)THEN
              ...
              IF(LC.NE.LI)CALL wrf_error_fatal3("<stdin>",1519,&
